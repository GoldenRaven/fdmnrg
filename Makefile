...
objects=main.o setup.o genoutput.o iterative_dia.o dos3.o date_time.o deallocate.o func_wn.o thermal_dynamic_quantity.o
...
iterative_dia.o: iterative_dia.cpp setup.h struct.h
